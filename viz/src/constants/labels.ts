...
export const PIPELINE_DESC: Record<Pipeline, string> = {
  factorDev: '9 base parties + 28 crossover variants. Each variant shifts one ideological axis by ±25% — producing candidates like SD_hi_so (a Social Democrat who runs tougher on security) or CON_lo_pc (a Conservative who softens on populism).',
