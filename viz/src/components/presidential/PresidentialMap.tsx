  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 mb-3">
        <span className="text-xs font-semibold text-muted-foreground uppercase tracking-widest">View:</span>
      ...
      <div className="relative" aria-label="Presidential election results map" role="img">
        {tooltip && (
          <div className="absolute top-2 left-2 bg-white border border-slate-300 rounded px-3 py-2 text-sm text-foreground z-10 pointer-events-none max-w-sm shadow-sm" role="status" aria-live="polite">
            {tooltip}
          </div>
        )}
      ...
      <div className="flex flex-wrap gap-2 mt-3 justify-center">
        {legendEntries.map(([code, { states, evs }]) => (
          ...
          >
            {code}
            <span className="bg-muted text-muted-foreground rounded px-1">
