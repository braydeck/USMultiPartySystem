...
export function LegislationTab({ houseVotes, senateVotes, fdElection, rawMultiElection }: Props) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="sticky top-[40px] z-10 bg-white/95 backdrop-blur-sm border-b border-slate-100 -mx-4 px-4 py-2 flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs text-slate-400 uppercase tracking-widest">Senate Method</span>
          <div className="flex gap-1">
