...
BILL_VARS = (
    ...
    # Abortion. The whole CC24_324* battery is out — a/b/c are mutually exclusive positions on one
    # scale, so no chamber could pass more than one, and d is a stance too. CC24_340a (protect
    # contraception access) is out as well: CC24_340b already puts restricting abortion access on
    # the floor. All of them remain policy-comparison items on the Parties tab.
    "CC24_340b", "CC24_444c", "CC24_444d",
    # Civil liberties
